...
function findWasmBinary() {
  return locateFile('projection_engine.wasm');
}
...
var _engine_initialize = Module['_engine_initialize'] = makeInvalidEarlyAccess('_engine_initialize');
var _engine_render_frame = Module['_engine_render_frame'] = makeInvalidEarlyAccess('_engine_render_frame');
var _engine_on_mouse_drag = Module['_engine_on_mouse_drag'] = makeInvalidEarlyAccess('_engine_on_mouse_drag');
var _engine_on_mouse_scroll = Module['_engine_on_mouse_scroll'] = makeInvalidEarlyAccess('_engine_on_mouse_scroll');
var _engine_on_resize = Module['_engine_on_resize'] = makeInvalidEarlyAccess('_engine_on_resize');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['engine_initialize'] != 'undefined', 'missing Wasm export: engine_initialize');
  assert(typeof wasmExports['engine_render_frame'] != 'undefined', 'missing Wasm export: engine_render_frame');
  assert(typeof wasmExports['engine_on_mouse_drag'] != 'undefined', 'missing Wasm export: engine_on_mouse_drag');
  assert(typeof wasmExports['engine_on_mouse_scroll'] != 'undefined', 'missing Wasm export: engine_on_mouse_scroll');
  assert(typeof wasmExports['engine_on_resize'] != 'undefined', 'missing Wasm export: engine_on_resize');
  ...
  _engine_initialize = Module['_engine_initialize'] = createExportWrapper('engine_initialize', 2);
  _engine_render_frame = Module['_engine_render_frame'] = createExportWrapper('engine_render_frame', 0);
  _engine_on_mouse_drag = Module['_engine_on_mouse_drag'] = createExportWrapper('engine_on_mouse_drag', 2);
  _engine_on_mouse_scroll = Module['_engine_on_mouse_scroll'] = createExportWrapper('engine_on_mouse_scroll', 1);
  _engine_on_resize = Module['_engine_on_resize'] = createExportWrapper('engine_on_resize', 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = createProjectionEngine;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createProjectionEngine);
